...
// echo "<pre>"; print_r($orderItems);echo "</pre>";
 $nam = $details->customer_id;
 $name = Registration::find()->where(['id'=>$nam])->one();       
...
<div class="row" style='position:relative'>
  <div class="col-md-12" style="text-align:center;">
    ...
    <div class="schoolname"><b>Hostel</b></div>
    <div style="font-size:20px">Imphal</div>
  ...
  <div class="row" style="padding:0px 15px 15px 15px;">
    ...
    <table style="border:solid black 1px;width:100%;">
      <tr >
        ...
        <td colspan="2" style="text-align:center;" class="txt">Rs <?= $details->amount_receive ?></td>
      </tr>
      <tr>
        <td colspan="4" style="background:gray;color:white" class="txt">On account of </td>  
        <td colspan="2" style="text-align:center;" class="txt"> <?= "Monthly Fee for the hostel" ?></td>
      </tr>
      <tr >
        <td colspan="1" style="background:gray;color:white" class="txt">From </td>  
        <td colspan="5" style="text-align:center;" class="txt"><?= $name->name?> </td>
      ...
      <tr >
        <td colspan="4" style="background:gray;color:white" class="txt">Due Amount (if any)</td>  
        <td colspan="2" style="text-align:center;" class="txt">Rs <?= $details->due_amount ?></td>
      </tr>
      ...
      <tr >
        <td colspan="1" style="background:gray;color:white" class="txt">Date of Payment</td>
